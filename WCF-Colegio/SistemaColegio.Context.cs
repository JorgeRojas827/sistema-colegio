...
namespace WCF_Colegio
{
    ...
    public partial class BDCOLEGIOEntities : DbContext
    {
        ...
        public virtual int usp_EditarCurso(Nullable<int> idCurso, string descripcion, Nullable<bool> activo, ObjectParameter resultado)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_EditarCurso", idCursoParameter, descripcionParameter, activoParameter, resultado);
        }
    
        public virtual int usp_EditarDocente(Nullable<int> idDocente, string documentoIdentidad, string nombres, string apellidos, Nullable<System.DateTime> fechaNacimiento, string sexo, string gradoEstudio, string ciudad, string direccion, string email, string numeroTelefono, Nullable<bool> activo, ObjectParameter resultado)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_EditarDocente", idDocenteParameter, documentoIdentidadParameter, nombresParameter, apellidosParameter, fechaNacimientoParameter, sexoParameter, gradoEstudioParameter, ciudadParameter, direccionParameter, emailParameter, numeroTelefonoParameter, activoParameter, resultado);
        }
        ...
        public virtual int usp_RegistrarCurso(string descripcion, ObjectParameter resultado)
        {
            var descripcionParameter = descripcion != null ?
                new ObjectParameter("Descripcion", descripcion) :
                new ObjectParameter("Descripcion", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_RegistrarCurso", descripcionParameter, resultado);
        }
    
        public virtual int usp_RegistrarDocente(string documentoIdentidad, string nombres, string apellidos, Nullable<System.DateTime> fechaNacimiento, string sexo, string gradoEstudio, string ciudad, string direccion, string email, string numeroTelefono, ObjectParameter resultado)
        {
            var documentoIdentidadParameter = documentoIdentidad != null ?
                new ObjectParameter("DocumentoIdentidad", documentoIdentidad) :
                new ObjectParameter("DocumentoIdentidad", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_RegistrarDocente", documentoIdentidadParameter, nombresParameter, apellidosParameter, fechaNacimientoParameter, sexoParameter, gradoEstudioParameter, ciudadParameter, direccionParameter, emailParameter, numeroTelefonoParameter, resultado);
        }
